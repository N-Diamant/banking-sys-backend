...
public class BankingServiceImpl implements BankingService {
    ...
    public Transaction withdraw(Long customerId, Double amount) {
        ...
        if (customer.getBalance().compareTo(Double.valueOf(amount)) < 0) {
    ...
    @Override
    @Transactional
    public Transaction transfer(Long fromCustomerId, Long toCustomerId, Double amount) {
    ...
    private void sendTransactionEmail(Customer customer, Double amount, String transactionType) {
        try {
    ...
    private void registerMessage(Customer customer, Double amount, String transactionType) {
